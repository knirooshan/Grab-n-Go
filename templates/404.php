        ...
        <div class="row">
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto text-center">
                <div class="error-content py-4">
                    ...
                    <p class="mb-4">The page you are looking for was moved, removed, renamed or might never existed.</p>
                    <form class="search-404 mb-4" id="404search" action="#" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control input-group-field" name="search" value=""
                                placeholder="How can we help?" required />
                            <button type="submit" class="action d-flex-justify-center btn btn-secondary"><i
                                    class="icon anm anm-search-l"></i></button>
                        </div>
                    </form>
                    <p class="same-width-btn"><a href="" class="btn btn-secondary btn-lg mb-2 mx-3">Go
                            Back</a><a href="" class="btn btn-lg mb-2">Continue shopping</a></p>
                </div>
            </div>
        </div>
    </div>
