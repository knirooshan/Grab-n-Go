                ...
                <div class="dashboard-sidebar bg-block">
                    <div class="profile-top text-center mb-4 px-3">
                        <div class="profile-image mb-3">
                            <img class="rounded-circle blur-up lazyload" data-src="assests/images/users/user-img3.jpg"
                                src="assests/images/users/user-img3.jpg" alt="user" width="130" />
                        </div>
                    ...
                    <div class="dashboard-tab">
                        <ul class="nav nav-tabs flex-lg-column border-bottom-0" id="top-tab" role="tablist">
                            ...
                            <li class="nav-item"><a href="#" data-bs-toggle="tab" data-bs-target="#orderstracking"
                                    class="nav-link">Orders tracking</a></li>
                            ...
                            <div class="row g-3 row-cols-lg-3 row-cols-md-3 row-cols-sm-3 row-cols-1 mb-4">
                                <div class="counter-box">
                                    <div class="bg-block d-flex-center flex-nowrap">
                                        <img class="blur-up lazyload" data-src="assests/images/icons/sale.png"
                                            src="assests/images/icons/sale.png" alt="icon" width="64" height="64" />
                                        <div class="content">
                                ...
                                <div class="counter-box">
                                    <div class="bg-block d-flex-center flex-nowrap">
                                        <img class="blur-up lazyload" data-src="assests/images/icons/homework.png"
                                            src="assests/images/icons/homework.png" alt="icon" width="64" height="64" />
                                        <div class="content">
                                ...
                                <div class="counter-box">
                                    <div class="bg-block d-flex-center flex-nowrap">
                                        <img class="blur-up lazyload" data-src="assests/images/icons/order.png"
                                            src="assests/images/icons/order.png" alt="icon" width="64" height="64" />
                                        <div class="content">
                        ...
                        <div class="address-card mt-0 h-100">
                            <div class="top-sec d-flex-justify-center justify-content-between mb-4">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#addNewModal"><i class="icon anm anm-plus-r me-1"></i> Add
                                    New</button>
                                <!-- New Address Modal -->
                                                ...
                                                <form class="add-address-from" method="post" action="#">
                                                    <div
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="name" placeholder="Name" value="" id="new-name"
                                                                type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="new-type" class="d-none">Address type <span
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="company" placeholder="Company" value=""
                                                                id="new-company" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="new-apartment" class="d-none">Apartment <span
                                                                    class="required">*</span></label>
                                                            <input name="apartment" placeholder="Apartment" value=""
                                                                id="new-apartment" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="new-street-address" class="d-none">Street
                                                                Address <span class="required">*</span></label>
                                                            <input name="street_address" placeholder="Street Address"
                                                                value="" id="new-street-address" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="new-city" class="d-none">City <span
                                                                    class="required">*</span></label>
                                                            <input name="city" placeholder="City" value="" id="new-city"
                                                                type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="new-postcode" class="d-none">Post Code <span
                                                                    class="required">*</span></label>
                                                            <input name="postcode" placeholder="Post Code" value=""
                                                                id="new-postcode" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="new-telephone" class="d-none">Telephone <span
                                                                    class="required">*</span></label>
                                                            <input name="telephone" placeholder="Telephone" value=""
                                                                id="new-telephone" type="tel">
                                                        </div>
                                                        <div class="form-group mb-md-0">
                                                            <label for="new-zone" class="d-none">Region / State <span
                                                                    class="required">*</span></label>
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <label for="new-country" class="d-none">Country <span
                                                                    class="required">*</span></label>
                                        ...
                                        <div class="address-box bg-block">
                                            <div class="top d-flex-justify-center justify-content-between mb-3">
                                                ...
                                                <span class="product-labels start-auto end-0"><span
                                                        class="lbl pr-label1">Home</span></span>
                                            </div>
                                            <div class="middle">
                                            ...
                                            <div class="bottom d-flex-justify-center justify-content-between">
                                                <button type="button" class="bottom-btn btn btn-gray btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#addEditModal">Edit</button>
                                                <button type="button"
                                                    class="bottom-btn btn btn-gray btn-sm">Remove</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="address-select-box">
                                        <div class="address-box bg-block">
                                            <div class="top d-flex-justify-center justify-content-between mb-3">
                                                <h5 class="m-0">Hema Jecno</h5>
                                                <span class="product-labels start-auto end-0"><span
                                                        class="lbl pr-label4">Office</span></span>
                                            </div>
                                            <div class="middle">
                                                <div class="address mb-2 text-muted">
                                                    <address class="m-0">123, The Company Name Inc, <br />Street Road
                                            ...
                                            <div class="modal-body">
                                                <form class="edit-address-from" method="post" action="#">
                                                    <div
                                                        ...
                                                        <div class="form-group">
                                                            <label for="edit-type" class="d-none">Address type <span
                                                                    class="required">*</span></label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="edit-apartment" class="d-none">Apartment <span
                                                                    class="required">*</span></label>
                                                            <input name="apartment" placeholder="Apartment" value=""
                                                                id="edit-apartment" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="edit-street-address" class="d-none">Street
                                                                Address <span class="required">*</span></label>
                                                            <input name="street_address" placeholder="Street Address"
                                                                value="" id="edit-street-address" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="edit-city" class="d-none">City <span
                                                                    class="required">*</span></label>
                                                            <input name="city" placeholder="City" value=""
                                                                id="edit-city" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="edit-postcode" class="d-none">Post Code <span
                                                                    class="required">*</span></label>
                                                            <input name="postcode" placeholder="Post Code" value=""
                                                                id="edit-postcode" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="edit-telephone" class="d-none">Telephone <span
                                                                    class="required">*</span></label>
                                                            <input name="telephone" placeholder="Telephone" value=""
                                                                id="edit-telephone" type="tel">
                                                        </div>
                                                        <div class="form-group mb-md-0">
                                                            <label for="edit-zone" class="d-none">Region / State <span
                                                                    class="required">*</span></label>
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <label for="edit-country" class="d-none">Country <span
                                                                    class="required">*</span></label>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="blur-up lazyload"
                                                    ...
                                                    src="assests/images/products/product1-120x170.jpg" width="50"
                                        ...
                                        <tr>
                                            <td><img class="blur-up lazyload"
                                                    ...
                                                    src="assests/images/products/product2-120x170.jpg" width="50"
                                                    alt="product" title="product" /></td>
                                        ...
                                        <tr>
                                            <td><img class="blur-up lazyload"
                                                    data-src="assests/images/products/product3-120x170.jpg"
                                                    src="assests/images/products/product3-120x170.jpg" width="50"
                                                    alt="product" title="product" /></td>
                                        ...
                                        <tr>
                                            <td><img class="blur-up lazyload"
                                                    data-src="assests/images/products/product4-120x170.jpg"
                                                    src="assests/images/products/product4-120x170.jpg" width="50"
                                                    alt="product" title="product" /></td>
                            ...
                            <form class="orderstracking-from" method="post" action="#">
                                ...
                                <div class="row align-items-center">
                                    <div class="form-group col-md-5 col-lg-5">
                                        ...
                                        <input name="orderId" placeholder="Order ID" value="" id="orderId" type="text"
                                            required>
                                    </div>
                                    <div class="form-group col-md-5 col-lg-5">
                                        <label for="billingEmail" class="d-none">Billing email <span
                                                class="required-f">*</span></label>
                                        <input name="billingEmail" placeholder="Billing email" value=""
                                            id="billingEmail" type="text" required>
                                    </div>
                                        ...
                                        <div class="col-lg-2 col-md-3 col-sm-4">
                                            <div class="product-img mb-3 mb-sm-0">
                                                <img class="rounded-0 blur-up lazyload"
                                                    data-src="assests/images/products/orders-tracking-product.jpg"
                                                    src="assests/images/products/orders-tracking-product.jpg"
                                        ...
                                        <table class="table align-middle text-center order-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>10.00 AM</td>
                                                    <td><span
                                                            class="badge rounded-pill bg-secondary custom-badge">Origin
                                                            scan</span></td>
                                                    <td>Landon</td>
                                                </tr>
                                            </tbody>
                    ...
                    <div class="tab-pane fade h-100" id="payment">
                        <div class="banks-card mt-0 h-100">
                            <div class="top-sec d-flex-justify-center justify-content-between mb-4">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#addCardModal"><i class="icon anm anm-plus-r me-1"></i> Add
                                    New</button>
                                <!-- New Card Modal -->
                                                ...
                                                <form class="add-card-from" method="post" action="#">
                                                    <div class="form-row">
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                                            ...
                                                            <input name="card-number" placeholder="Card Number" value=""
                                                                id="card-number" type="text" />
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                            <label for="bank-card" class="d-none">Card <span
                                                                    class="required">*</span></label>
                                                            <select id="bank-card" class="form-control">
                                                                <option value="0" label="Select a card"
                                                                    selected="selected">Select a card</option>
                                                        ...
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                            <label for="cvv-code" class="d-none">CVV Code <span
                                                                    class="required">*</span></label>
                                                            <input name="cvv-code" placeholder="CVV Code" value=""
                                                                id="cvv-code" type="text" />
                                                        </div>
                                                        <div
                                                            class="form-group col-lg-6 col-md-6 col-sm-12 col-12 mb-md-0">
                                                            <label for="card-month" class="d-none">Month <span
                                                                    class="required">*</span></label>
                                                            <select id="card-month" class="form-control">
                                                                <option value="0" label="Select a month"
                                                                    selected="selected">Select a month</option>
                                                        ...
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12 mb-0">
                                                            <label for="card-year" class="d-none">Year <span
                                                                    class="required">*</span></label>
                                                            <select id="card-year" class="form-control">
                                                                <option value="0" label="Select a year"
                                                                    selected="selected">Select a year</option>
                                ...
                                <div class="row g-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1">
                                    <div class="address-select-box active">
                                        <div class="address-box bg-block">
                                            <div
                                                ...
                                                <img src="assests/images/icons/bank-logo1.png" class="bank-logo"
                                                    width="40" alt="" />
                                                <img src="assests/images/icons/visa-logo.png" class="network-logo"
                                                    width="50" alt="" />
                                            </div>
                                            <div class="middle">
                                            ...
                                            <div class="bottom d-flex-justify-center justify-content-between">
                                                <button type="button" class="bottom-btn btn btn-gray btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#editCardModal">Edit</button>
                                                <button type="button"
                                                    class="bottom-btn btn btn-gray btn-sm">Remove</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="address-select-box">
                                        <div class="address-box bg-block">
                                            <div
                                                class="top bank-logo d-flex-justify-center justify-content-between mb-3">
                                                <img src="assests/images/icons/bank-logo2.png" class="bank-logo"
                                                    width="100" alt="" />
                                                <img src="assests/images/icons/visa-logo.png" class="network-logo"
                                                    width="50" alt="" />
                                            </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                                                            <label for="editCard-number" class="d-none">Card
                                                                Number</label>
                                                            <input name="editCard-number" placeholder="Card Number"
                                                                value="" id="editCard-number" type="text" />
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                            <label for="editBank-card" class="d-none">Card <span
                                                                    class="required">*</span></label>
                                                        ...
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                            <label for="editCvv-code" class="d-none">CVV Code <span
                                                                    class="required">*</span></label>
                                                            <input name="editCvv-code" placeholder="CVV Code" value=""
                                                                id="editCvv-code" type="text" />
                                                        </div>
                                                        <div
                                                            class="form-group col-lg-6 col-md-6 col-sm-12 col-12 mb-md-0">
                                                            <label for="editCard-month" class="d-none">Month <span
                                                                    class="required">*</span></label>
                                                        ...
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12 mb-0">
                                                            <label for="editCard-year" class="d-none">Year <span
                                                                    class="required">*</span></label>
                    ...
                    <div class="tab-pane fade h-100" id="profile">
                        <div class="profile-card mt-0 h-100">
                            <div class="top-sec d-flex-justify-center justify-content-between mb-4">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editProfileModal"><i class="icon anm anm-plus-r me-1"></i>
                                    Edit</button>
                            </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                                                        <div
                                                            ...
                                                            <img src="assests/images/users/user-img3.jpg"
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                        <label for="editProfile-Companyname" class="d-none">Company
                                                            name</label>
                                                        <input name="editProfile-Companyname" placeholder="Company name"
                                                            value="" id="editProfile-Companyname" type="text" />
                                                    </div>
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                        <label for="editProfile-Phonenumber" class="d-none">Phone
                                                            number</label>
                                                        <input name="editProfile-Phonenumber" placeholder="Phone number"
                                                            value="" id="editProfile-Phonenumber" type="text" />
                                                    </div>
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                        <label for="editProfile-zone" class="d-none">City / State <span
                                                                class="required">*</span></label>
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                        ...
                                                        <input name="editProfile-Zipcode" placeholder="Zip code"
                                                            value="" id="editProfile-Zipcode" type="text" />
                                                    </div>
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                        <label for="editProfile-Category"
                                                            class="d-none">Category</label>
                                                        <input name="editProfile-Category" placeholder="Phone number"
                                                            value="" id="editProfile-Category" type="text" />
                                                    </div>
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12 mb-0">
                                                        <label for="editProfile-TotalEmployees" class="d-none">Zip
                                                            code</label>
                                                        <input name="editProfile-TotalEmployees" placeholder="Zip code"
                                                            value="" id="editProfile-TotalEmployees" type="text" />
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <div class="top-sec d-flex-justify-center justify-content-between mb-4">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editLoginModal"><i class="icon anm anm-plus-r me-1"></i>
                                    Edit</button>
                            </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-group">
                                                        <label for="editLogin-Emailaddress" class="d-none">Email address
                                                            <span class="required">*</span></label>
                                                        <input name="editLogin-Emailaddress" placeholder="Email address"
                                                            value="" id="editLogin-Emailaddress" type="email" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="editLogin-Phonenumber" class="d-none">Phone number
                                                            <span class="required">*</span></label>
                                                        <input name="editLogin-Phonenumber" placeholder="Phone number"
                                                            value="" id="editLogin-Phonenumber" type="text" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="editLogin-Password" class="d-none">Current Password
                                                            <span class="required">*</span></label>
                                                        <input name="editLogin-Password" placeholder="Current Password"
                                                            value="" id="editLogin-Password" type="password" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="editLogin-NewPassword" class="d-none">New Password
                                                            <span class="required">*</span></label>
                                                        <input name="editLogin-NewPassword" placeholder="New Password"
                                                            value="" id="editLogin-NewPassword" type="password" />
                                        ...
                                        <div class="account-setting">
                                            ...
                                            <div class="account-detail form-group">
                                                <div class="customCheckbox clearfix mb-2">
                                                    <input name="NotificationsAC" id="n1" value="1" checked="checked"
                                                        type="checkbox" />
                                        ...
                                        <div class="account-setting">
                                            ...
                                            <div class="account-detail form-group">
                                                <div class="customRadio clearfix mb-2">
                                                    <input name="DeactivateAC" id="d1" value="1" checked="checked"
                                                        type="radio" />
