            ...
            <div class="row align-items-center">
                <div class="col-12 col-sm-12 col-md-6">
                    <div class="about-images mb-4 mb-md-0">
                        <div class="row g-3">
                            <img class="rounded-0 blur-up lazyload" data-src="assests/images/about/about3.jpg"
                                src="assests/images/about/about3.jpg" alt="about" width="700" height="827" />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-sm-12 col-md-6">
                    <div class="about-details px-50 py-5">
                        ...
                        <p>Through strategy, design, and planning we build brand identities that connect with your
                            template. We then fine-tune a marketing plan that allows us to laser focus.</p>
                ...
                <div class="col-12 col-sm-12 col-md-6">
                    <div class="about-images mt-4 mt-md-0">
                        <div class="row g-3">
                            <img class="rounded-0 blur-up lazyload" data-src="assests/images/about/about1.jpg"
                                src="assests/images/about/about1.jpg" alt="about" width="700" height="827" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="team-items row col-row row-cols-lg-4 row-cols-md-4 row-cols-sm-2 row-cols-2 text-center">
                <div class="team-item col-item">
                    <div class="team-img zoom-scal rounded-0">
                        <img class="rounded-0 blur-up lazyload w-100" data-src="assests/images/about/about-team1.jpg"
                            src="assests/images/about/about-team1.jpg" alt="team" width="350" height="350" />
                ...
                <div class="team-item col-item">
                    <div class="team-img zoom-scal rounded-0">
                        <img class="rounded-0 blur-up lazyload w-100" data-src="assests/images/about/about-team2.jpg"
                            src="assests/images/about/about-team2.jpg" alt="team" width="350" height="350" />
                        <ul class="list-inline social-icons d-flex-justify-center">
                            <li class="list-inline-item"><a class="clr-none" href="#" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Facebook"><i class="icon anm anm-facebook-f"></i></a>
                            </li>
                ...
                <div class="team-item col-item">
                    <div class="team-img zoom-scal rounded-0">
                        <img class="rounded-0 blur-up lazyload w-100" data-src="assests/images/about/about-team3.jpg"
                            src="assests/images/about/about-team3.jpg" alt="team" width="350" height="350" />
                        <ul class="list-inline social-icons d-flex-justify-center">
                            <li class="list-inline-item"><a class="clr-none" href="#" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Facebook"><i class="icon anm anm-facebook-f"></i></a>
                            </li>
                ...
                <div class="team-item col-item">
                    <div class="team-img zoom-scal rounded-0">
                        <img class="rounded-0 blur-up lazyload w-100" data-src="assests/images/about/about-team4.jpg"
                            src="assests/images/about/about-team4.jpg" alt="team" width="350" height="350" />
                        <ul class="list-inline social-icons d-flex-justify-center">
                            <li class="list-inline-item"><a class="clr-none" href="#" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Facebook"><i class="icon anm anm-facebook-f"></i></a>
                            </li>
                ...
                <div class="testimonial-slider-3items gp15 slick-arrow-dots arwOut5">
                    <div class="testimonial-slide rounded-3">
                        <div class="testimonial-content text-center">
                            <div class="quote-icon mb-3 mb-lg-4"><img class="blur-up lazyload mx-auto"
                                    data-src="assests/images/icons/demo1-quote-icon.png"
                                    src="assests/images/icons/demo1-quote-icon.png" alt="icon" width="40" height="40" />
                            </div>
                            <div class="content">
                                <div class="text mb-2">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text 1500s.</p>
                                </div>
                            ...
                            <div class="auhimg d-flex-justify-center text-left">
                                <div class="image"><img class="rounded-circle blur-up lazyload"
                                        data-src="assests/images/users/testimonial1-65x.jpg"
                                        src="assests/images/users/testimonial1-65x.jpg" alt="quotes" width="65"
                                        height="65" /></div>
                    ...
                    <div class="testimonial-slide rounded-3">
                        <div class="testimonial-content text-center">
                            ...
                            <div class="auhimg d-flex-justify-center text-left">
                                <div class="image"><img class="rounded-circle blur-up lazyload"
                                        data-src="assests/images/users/testimonial2-65x.jpg"
                                        src="assests/images/users/testimonial2-65x.jpg" alt="quotes" width="65"
                                        height="65" /></div>
                                <div class="auhtext ms-3">
                    ...
                    <div class="testimonial-slide rounded-3">
                        <div class="testimonial-content text-center">
                            ...
                            <div class="auhimg d-flex-justify-center text-left">
                                <div class="image"><img class="rounded-circle blur-up lazyload"
                                        data-src="assests/images/users/testimonial3-65x.jpg"
                                        src="assests/images/users/testimonial3-65x.jpg" alt="quotes" width="65"
                                        height="65" /></div>
                                <div class="auhtext ms-3">
                    ...
                    <div class="testimonial-slide rounded-3">
                        <div class="testimonial-content text-center">
                            ...
                            <div class="auhimg d-flex-justify-center text-left">
                                <div class="image"><img class="rounded-circle blur-up lazyload"
                                        data-src="assests/images/users/testimonial4-65x.jpg"
                                        src="assests/images/users/testimonial4-65x.jpg" alt="quotes" width="65"
                                        height="65" /></div>
                                <div class="auhtext ms-3">
